...
def run(output_path, assembly, lineage, bam, reads=None, reference=None):
    ...
    trim_name, trim_area = Cont.run()
    statistics, fragments, scaffolds_l, cleaned_scaffolds_l = run_statistic(assembly, trim_name, trim_area, output_path)
    Cont.contamination_score(scaffolds_l, cleaned_scaffolds_l)
